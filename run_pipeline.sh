...
while true; do
    ...
    echo "            MAIN MENU"
    echo "=========================================="
    echo "1. Run Pipeline with Plugin Selection"
    echo "2. Configure Stocks & Date Range"
    echo "3. Git: View status & commit changes"
    echo "4. Exit"
    ...
    if [ "$choice" == "1" ]; then
        ...
        echo "Launching configuration manager..."
        .venv/bin/python config_manager.py
